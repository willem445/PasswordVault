...
namespace PasswordVault.Services
{
    ...
    public interface IPasswordService
    {
        ...
        AddPasswordResult AddPassword(string userUuid, Password password, string key, EncryptionServiceParameters parameters);
        ...
        AddModifyPasswordResult ModifyPassword(string userUuid, Password modifiedPassword, string key, EncryptionServiceParameters parameters);
        ...
        List<Password> GetPasswords(string userUuid, string decryptionKey, EncryptionServiceParameters parameters);
